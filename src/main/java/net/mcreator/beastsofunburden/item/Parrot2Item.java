...
import net.mcreator.beastsofunburden.item.inventory.Parrot2InventoryCapability;

import javax.annotation.Nullable;

import io.netty.buffer.Unpooled;

public class Parrot2Item extends Item {
	public Parrot2Item() {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openGui(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return new TextComponent("Red Parrot Villager Key");
				}
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new Parrot2InventoryCapability();
	}
