...
import net.mcreator.beastsofunburden.item.inventory.Parrot1InventoryCapability;

import javax.annotation.Nullable;

import io.netty.buffer.Unpooled;

public class Parrot1Item extends Item {
	public Parrot1Item() {
		super(new Item.Properties().tab(null).stacksTo(1).fireResistant().rarity(Rarity.UNCOMMON));
	}
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openGui(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return new TextComponent("Cyan Parrot Villager Key");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new KeyringGUIMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new Parrot1InventoryCapability();
	}
