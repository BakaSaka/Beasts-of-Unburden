...
public class WolfVariationSpawnProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (entity instanceof LivingEntity _livEnt0 && _livEnt0.isBaby()) {
			if (world instanceof ServerLevel _level) {
				Entity entityToSpawn = new BabyWolfVillagerEntity(BouModEntities.BABY_WOLF_VILLAGER.get(), _level);
			...
			if (entity instanceof WolfVillagerEntity _datEntSetI)
				_datEntSetI.getEntityData().set(WolfVillagerEntity.DATA_variant, Mth.nextInt(new Random(), 1, 10));
		}
	}
}