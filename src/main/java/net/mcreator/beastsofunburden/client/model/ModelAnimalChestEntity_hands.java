...
public class ModelAnimalChestEntity_hands<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("bou", "model_animal_chest_entity_hands"), "main");
	...
	public ModelAnimalChestEntity_hands(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition villager_portrait_r1 = up_frame.addOrReplaceChild("villager_portrait_r1", CubeListBuilder.create().texOffs(40, 51).mirror().addBox(-5.5F, -10.0F, 0.0F, 11.0F, 9.5F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 1.0F, 0.0F, -0.3927F, 0.0F, 0.0F));
		PartDefinition bone = partdefinition.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(0, 37).addBox(-14.5F, -16.0F, 1.0F, 6.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(44, 37).addBox(-7.5F, -16.0F, 1.0F, 6.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 30)
						.addBox(-7.5F, -8.0F, 1.0F, 6.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(44, 30).addBox(-14.5F, -8.0F, 1.0F, 6.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)),
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		this.bone.zRot = (Mth.sin(ageInTicks * 0.6F) * 0.6F);
	}
}