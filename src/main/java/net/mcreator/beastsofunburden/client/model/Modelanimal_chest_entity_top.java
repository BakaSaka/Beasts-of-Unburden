...
public class Modelanimal_chest_entity_top<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("bou", "modelanimal_chest_entity_top"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition top_entity = partdefinition.addOrReplaceChild("top_entity",
				CubeListBuilder.create().texOffs(0, 37).addBox(-14.5F, -16.0F, 1.0F, 6.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(44, 37).addBox(-7.5F, -16.0F, 1.0F, 6.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)),
