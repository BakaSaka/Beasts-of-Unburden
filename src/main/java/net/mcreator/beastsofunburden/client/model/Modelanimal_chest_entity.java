...
public class Modelanimal_chest_entity<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition screen_r1 = up_frame.addOrReplaceChild("screen_r1", CubeListBuilder.create().texOffs(40, 51).mirror().addBox(-5.5F, -10.0F, 0.0F, 11.0F, 9.5F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
