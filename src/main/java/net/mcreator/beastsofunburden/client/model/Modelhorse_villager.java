...
public class Modelhorse_villager<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition nose = partdefinition.addOrReplaceChild("nose",
				CubeListBuilder.create().texOffs(32, 0).addBox(-3.0F, -6.0F, -9.5F, 6.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(22, 0).addBox(-2.5F, -1.0F, -8.0F, 5.0F, -1.0F, 6.0F, new CubeDeformation(0.0F)),
