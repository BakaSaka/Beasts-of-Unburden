...
public class SpiderVillagerRenderer extends MobRenderer<SpiderVillagerEntity, Modelparrot_villager<SpiderVillagerEntity>> {
	public SpiderVillagerRenderer(EntityRendererProvider.Context context) {
		super(context, new Modelparrot_villager<SpiderVillagerEntity>(context.bakeLayer(Modelparrot_villager.LAYER_LOCATION)), 0.5f);
		this.addLayer(new RenderLayer<SpiderVillagerEntity, Modelparrot_villager<SpiderVillagerEntity>>(this) {
