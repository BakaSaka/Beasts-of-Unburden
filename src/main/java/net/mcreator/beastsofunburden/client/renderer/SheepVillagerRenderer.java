...
public class SheepVillagerRenderer extends MobRenderer<SheepVillagerEntity, Modelparrot_villager<SheepVillagerEntity>> {
	public SheepVillagerRenderer(EntityRendererProvider.Context context) {
		super(context, new Modelparrot_villager<SheepVillagerEntity>(context.bakeLayer(Modelparrot_villager.LAYER_LOCATION)), 0.5f);
		this.addLayer(new RenderLayer<SheepVillagerEntity, Modelparrot_villager<SheepVillagerEntity>>(this) {
