...
public class TurtleVillagerRenderer extends MobRenderer<TurtleVillagerEntity, Modelparrot_villager<TurtleVillagerEntity>> {
	public TurtleVillagerRenderer(EntityRendererProvider.Context context) {
		super(context, new Modelparrot_villager<TurtleVillagerEntity>(context.bakeLayer(Modelparrot_villager.LAYER_LOCATION)), 0.5f);
		this.addLayer(new RenderLayer<TurtleVillagerEntity, Modelparrot_villager<TurtleVillagerEntity>>(this) {
