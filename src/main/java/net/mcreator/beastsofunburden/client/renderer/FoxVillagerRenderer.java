...
public class FoxVillagerRenderer extends MobRenderer<FoxVillagerEntity, Modelparrot_villager<FoxVillagerEntity>> {
	public FoxVillagerRenderer(EntityRendererProvider.Context context) {
		super(context, new Modelparrot_villager<FoxVillagerEntity>(context.bakeLayer(Modelparrot_villager.LAYER_LOCATION)), 0.5f);
		this.addLayer(new RenderLayer<FoxVillagerEntity, Modelparrot_villager<FoxVillagerEntity>>(this) {
