...
public class LlamaVillagerRenderer extends MobRenderer<LlamaVillagerEntity, Modelparrot_villager<LlamaVillagerEntity>> {
	public LlamaVillagerRenderer(EntityRendererProvider.Context context) {
		super(context, new Modelparrot_villager<LlamaVillagerEntity>(context.bakeLayer(Modelparrot_villager.LAYER_LOCATION)), 0.5f);
		this.addLayer(new RenderLayer<LlamaVillagerEntity, Modelparrot_villager<LlamaVillagerEntity>>(this) {
