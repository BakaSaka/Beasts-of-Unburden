...
public class ParrotVillagerRenderer extends MobRenderer<ParrotVillagerEntity, Modelparrot_villager<ParrotVillagerEntity>> {
	public ParrotVillagerRenderer(EntityRendererProvider.Context context) {
		super(context, new Modelparrot_villager<ParrotVillagerEntity>(context.bakeLayer(Modelparrot_villager.LAYER_LOCATION)), 0.5f);
		this.addLayer(new RenderLayer<ParrotVillagerEntity, Modelparrot_villager<ParrotVillagerEntity>>(this) {
			final ResourceLocation LAYER_TEXTURE = new ResourceLocation("bou:textures/entities/parrot_villager_cyan.png");

			@Override
			public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light, ParrotVillagerEntity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
	...
	@Override
	protected void scale(ParrotVillagerEntity entity, PoseStack poseStack, float f) {
		poseStack.scale(entity.getScale(), entity.getScale(), entity.getScale());
	}

	@Override
	public ResourceLocation getTextureLocation(ParrotVillagerEntity entity) {
