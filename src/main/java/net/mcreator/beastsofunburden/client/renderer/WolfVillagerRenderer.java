...
public class WolfVillagerRenderer extends MobRenderer<WolfVillagerEntity, Modelparrot_villager<WolfVillagerEntity>> {
	public WolfVillagerRenderer(EntityRendererProvider.Context context) {
		super(context, new Modelparrot_villager<WolfVillagerEntity>(context.bakeLayer(Modelparrot_villager.LAYER_LOCATION)), 0.5f);
		this.addLayer(new RenderLayer<WolfVillagerEntity, Modelparrot_villager<WolfVillagerEntity>>(this) {
