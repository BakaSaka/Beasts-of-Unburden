...
public class BabyParrotVillagerEntity extends Animal {
	...
	public BabyParrotVillagerEntity(EntityType<BabyParrotVillagerEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		BabyParrotVariationSpawnProcedure.execute(this);
		return retval;
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		BabyParrotVillagerEntity retval = BouModEntities.BABY_PARROT_VILLAGER.get().create(serverWorld);
