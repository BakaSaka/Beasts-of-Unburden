...
public class BouModItems {
	...
	static {
		...
		CAT_VILLAGER_SPAWN_EGG = REGISTRY.register("cat_villager_spawn_egg", () -> new ForgeSpawnEggItem(BouModEntities.CAT_VILLAGER, -6527464, -5997981, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
		COW_VILLAGER_SPAWN_EGG = REGISTRY.register("cow_villager_spawn_egg", () -> new ForgeSpawnEggItem(BouModEntities.COW_VILLAGER, -12636902, -5997981, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
