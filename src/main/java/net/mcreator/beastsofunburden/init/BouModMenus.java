...
public class BouModMenus {
	...
	public static final RegistryObject<MenuType<CompleteKeyringGUIMenu>> COMPLETE_KEYRING_GUI = REGISTRY.register("complete_keyring_gui", () -> IForgeMenuType.create(CompleteKeyringGUIMenu::new));
