...
public class Modelpanda_villager<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "panda_villager"), "main");
	...
	private final ModelPart armwear;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-5.0F, -9.0F, -4.0F, 10.0F, 9.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 4)
						.addBox(3.0F, -11.0F, 1.0F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 4).mirror()
						.addBox(-6.0F, -11.0F, 1.0F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition headwear = partdefinition.addOrReplaceChild("headwear", CubeListBuilder.create().texOffs(0, 35)
				.addBox(-5.0F, -9.0F, -4.0F, 10.0F, 7.0F, 8.0F, new CubeDeformation(0.5F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition nose = partdefinition.addOrReplaceChild("nose", CubeListBuilder.create().texOffs(30, 0).addBox(
				-2.5F, -2.0F, -6.0F, 5.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -2.0F, 0.0F));

		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(28, 12)
						.addBox(-5.0F, 0.0F, -3.0F, 10.0F, 13.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(20, 17)
						.addBox(-1.5F, 8.0F, 5.0F, 3.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition bodywear = partdefinition.addOrReplaceChild("bodywear", CubeListBuilder.create().texOffs(28, 43)
				.addBox(-5.0F, -0.6F, -3.0F, 10.0F, 13.0F, 8.0F, new CubeDeformation(0.5F)),
				PartPose.offset(0.0F, 1.0F, 0.0F));

		PartDefinition arms = partdefinition.addOrReplaceChild("arms",
				CubeListBuilder.create().texOffs(40, 33)
						.addBox(-4.0F, 2.0F, -2.0F, 8.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(48, 0)
		...
		PartDefinition armwear = partdefinition.addOrReplaceChild("armwear",
				CubeListBuilder.create().texOffs(28, 37).addBox(-8.0F, -2.0F, -2.0F, 4.0F, 2.0F, 4.0F,
						new CubeDeformation(0.2F)),
				PartPose.offsetAndRotation(0.0F, 2.95F, -1.05F, -0.7505F, 0.0F, 0.0F));

		PartDefinition mirrored2 = armwear.addOrReplaceChild("mirrored2",
				CubeListBuilder.create().texOffs(28, 37).mirror()
						.addBox(4.0F, -23.05F, -3.05F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.2F)).mirror(false),
				PartPose.offset(0.0F, 21.05F, 1.05F));

		PartDefinition right_leg = partdefinition.addOrReplaceChild("right_leg", CubeListBuilder.create().texOffs(0, 18)
				.addBox(-3.0F, 0.0F, -2.0F, 5.0F, 11.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.0F, 13.0F, 0.0F));

		PartDefinition right_legwear = partdefinition.addOrReplaceChild("right_legwear", CubeListBuilder.create()
				.texOffs(0, 50).addBox(-3.2F, 0.0F, -2.0F, 5.0F, 9.0F, 5.0F, new CubeDeformation(0.2F)),
				PartPose.offset(-2.0F, 13.0F, 0.0F));

		PartDefinition left_leg = partdefinition.addOrReplaceChild("left_leg",
				CubeListBuilder.create().texOffs(0, 18).mirror()
						.addBox(-2.0F, 0.0F, -2.0F, 5.0F, 11.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(2.0F, 13.0F, 0.0F));

		PartDefinition left_legwear = partdefinition.addOrReplaceChild("left_legwear",
				CubeListBuilder.create().texOffs(0, 50).mirror()
						.addBox(-1.8F, 0.0F, -2.0F, 5.0F, 9.0F, 5.0F, new CubeDeformation(0.2F)).mirror(false),
				PartPose.offset(2.0F, 13.0F, 0.0F));
