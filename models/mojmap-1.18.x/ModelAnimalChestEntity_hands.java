...
public class ModelAnimalChestEntity_hands<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "animalchestentity_hands"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(0, 37)
						...
						.addBox(-7.5F, -16.0F, 1.0F, 6.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 30)
						.addBox(-7.5F, -8.0F, 1.0F, 6.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(44, 30)
						.addBox(-14.5F, -8.0F, 1.0F, 6.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)),
