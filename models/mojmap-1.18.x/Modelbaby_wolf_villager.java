...
public class Modelbaby_wolf_villager<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "baby_wolf_villager"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-5.5F, -9.0F, -5.0F, 11.0F, 9.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(2, 18)
						.addBox(-5.5F, -13.0F, 1.0F, 5.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(2, 18)
						.mirror().addBox(0.5F, -13.0F, 1.0F, 5.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(0.0F, 2.0F, 0.0F));

		PartDefinition nose = partdefinition.addOrReplaceChild("nose", CubeListBuilder.create().texOffs(50, 19).addBox(
				-2.0F, -4.0F, -8.0F, 4.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 2.0F, 0.0F));
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(18, 20)
				.addBox(-4.5F, -22.0F, -3.0F, 9.0F, 12.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition tail = body.addOrReplaceChild("tail",
				CubeListBuilder.create().texOffs(36, 0)
						.addBox(-2.0F, -1.0F, 0.0F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(50, 0)
						.addBox(-2.0F, 0.0F, 3.0F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(49, 6)
						.addBox(-2.0F, 1.0F, 6.0F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition arms = partdefinition.addOrReplaceChild("arms",
				CubeListBuilder.create().texOffs(42, 12)
						.addBox(-4.0F, 3.0F, -2.0F, 8.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(52, 27)
		...
		PartDefinition right_leg = partdefinition.addOrReplaceChild("right_leg", CubeListBuilder.create().texOffs(4, 23)
				.addBox(-2.0F, -2.0F, -2.0F, 3.0F, 12.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.0F, 14.0F, 0.0F));

		PartDefinition left_leg = partdefinition.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(4, 23)
