	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(44, 13)
						...
						.addBox(-3.0F, -12.0F, 1.0F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 3).mirror()
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 36)
						.addBox(-3.5F, -2.0F, -2.0F, 7.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(16, 16)
		...
		PartDefinition bodywear = partdefinition.addOrReplaceChild("bodywear", CubeListBuilder.create().texOffs(36, 42)
				.addBox(-4.0F, 0.0F, -3.0F, 8.0F, 16.0F, 6.0F, new CubeDeformation(0.5F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition tail = partdefinition.addOrReplaceChild("tail",
				CubeListBuilder.create().texOffs(51, 0)
						.addBox(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(38, 10)
						.addBox(-2.0F, -1.0F, 1.0F, 4.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition arms = partdefinition.addOrReplaceChild("arms",
				CubeListBuilder.create().texOffs(20, 34)
						.addBox(-4.0F, 2.0F, -2.0F, 8.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(47, 26)
		...
		PartDefinition mirrored = arms.addOrReplaceChild("mirrored",
				CubeListBuilder.create().texOffs(47, 26).mirror()
						.addBox(4.0F, 0.3443F, -1.7443F, 4.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
