	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition top_entity = partdefinition.addOrReplaceChild("top_entity",
				CubeListBuilder.create().texOffs(0, 37)
						.addBox(-14.5F, -16.0F, 1.0F, 6.0F, 6.0F, 1.0F, new CubeDeformation(-0.05F)).texOffs(44, 37)
						.addBox(-7.5F, -16.0F, 1.0F, 6.0F, 6.0F, 1.0F, new CubeDeformation(-0.05F)),
				PartPose.offset(8.0F, 24.0F, -8.0F));

		PartDefinition bottom_entity = partdefinition.addOrReplaceChild("bottom_entity",
				CubeListBuilder.create().texOffs(0, 30)
						.addBox(-7.5F, -8.0F, 1.0F, 6.0F, 6.0F, 1.0F, new CubeDeformation(-0.05F)).texOffs(44, 30)
						.addBox(-14.5F, -8.0F, 1.0F, 6.0F, 6.0F, 1.0F, new CubeDeformation(-0.05F)),
				PartPose.offset(8.0F, 24.0F, -8.0F));
