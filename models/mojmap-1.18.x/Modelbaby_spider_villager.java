...
public class Modelbaby_spider_villager<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition right_leg_back_r1 = right_legs.addOrReplaceChild("right_leg_back_r1",
				CubeListBuilder.create().texOffs(28, 0).addBox(-1.0F, 0.0F, -2.5F, 2.0F, 6.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition left_leg_middle_r1 = right_legs.addOrReplaceChild(
				"left_leg_middle_r1", CubeListBuilder.create().texOffs(28, 0).addBox(-1.5F, 0.0F, -3.0F, 2.0F, 6.0F,
		...
		PartDefinition right_leg_middle_r1 = left_legs.addOrReplaceChild("right_leg_middle_r1",
				CubeListBuilder.create().texOffs(28, 0).mirror()
						.addBox(-0.5F, 0.0F, -3.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-3.0F, 0.0F, 2.0F, 0.0F, 0.0F, 0.7854F));

		PartDefinition left_leg_front_r1 = left_legs.addOrReplaceChild("left_leg_front_r1",
				CubeListBuilder.create().texOffs(28, 0).mirror()
						.addBox(-1.0F, 0.0F, -2.5F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(3.0F, 0.0F, -1.0F, -0.3927F, 0.0F, -0.7854F));
