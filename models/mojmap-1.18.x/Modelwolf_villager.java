...
public class Modelwolf_villager<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "wolf_villager"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-4.5F, -9.0F, -4.0F, 9.0F, 9.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 4)
						.addBox(-4.0F, -12.0F, 1.0F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 4).mirror()
						.addBox(1.0F, -12.0F, 1.0F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition nose = partdefinition.addOrReplaceChild("nose", CubeListBuilder.create().texOffs(38, 14).addBox(
				-2.0F, -4.0F, -9.0F, 4.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition headwear = partdefinition.addOrReplaceChild("headwear", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-4.5F, -9.0F, -4.0F, 9.0F, 9.0F, 8.0F, new CubeDeformation(0.51F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(16, 17)
						.addBox(-4.0F, 0.0F, -3.0F, 8.0F, 12.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(34, 0)
						.addBox(-1.5F, 8.0F, 3.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(43, 0)
						.addBox(-1.5F, 9.0F, 6.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(52, 0)
						.addBox(-1.5F, 10.0F, 9.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition arms = partdefinition.addOrReplaceChild("arms",
				CubeListBuilder.create().texOffs(34, 6)
						.addBox(-4.0F, 2.0F, -2.0F, 8.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(48, 19)
		...
		PartDefinition mirrored = arms.addOrReplaceChild("mirrored",
				CubeListBuilder.create().texOffs(48, 19).mirror()
						.addBox(4.0F, -2.4824F, -1.6456F, 4.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
