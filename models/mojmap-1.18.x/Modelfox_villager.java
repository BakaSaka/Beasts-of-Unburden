...
public class Modelfox_villager<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "fox_villager"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-4.5F, -8.0F, -4.0F, 9.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 3)
		...
		PartDefinition nose = partdefinition.addOrReplaceChild("nose", CubeListBuilder.create().texOffs(27, 0).addBox(
				-2.0F, -3.0F, -8.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition headwear = partdefinition.addOrReplaceChild("headwear", CubeListBuilder.create().texOffs(30, 35)
				.addBox(-4.5F, -8.0F, -4.0F, 9.0F, 6.0F, 8.0F, new CubeDeformation(0.51F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition headwear2 = partdefinition
				.addOrReplaceChild("headwear2",
						CubeListBuilder.create().texOffs(33, 49).addBox(-7.0F, -7.0F, -7.0F, 14.0F, 14.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.5708F, 0.0F, 0.0F));

		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(12, 16).addBox(
		...
		PartDefinition tail = body.addOrReplaceChild("tail",
				CubeListBuilder.create().texOffs(50, 0)
						.addBox(-1.5F, -1.5F, 0.0F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(46, 5)
						.addBox(-2.5F, -1.5F, 2.0F, 5.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(46, 14)
						.addBox(-2.5F, -0.5F, 6.0F, 5.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(49, 23)
						.addBox(-1.5F, 0.5F, 10.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition arms = partdefinition.addOrReplaceChild("arms",
				CubeListBuilder.create().texOffs(42, 29)
						.addBox(-4.0F, 3.0F, -1.0F, 8.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(34, 10)
		...
		PartDefinition mirrored = arms.addOrReplaceChild("mirrored",
				CubeListBuilder.create().texOffs(34, 10).mirror()
						.addBox(4.0F, -2.4824F, -0.6456F, 3.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition right_leg = partdefinition.addOrReplaceChild("right_leg", CubeListBuilder.create().texOffs(0, 16)
				.addBox(-2.0F, 0.0F, -1.5F, 3.0F, 12.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.0F, 12.0F, 0.0F));

		PartDefinition left_leg = partdefinition.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(0, 16)
				.addBox(-1.0F, 0.0F, -1.5F, 3.0F, 12.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(2.0F, 12.0F, 0.0F));
